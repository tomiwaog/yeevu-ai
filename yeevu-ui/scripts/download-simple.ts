...
async function downloadSimple(sandboxId: string, localPath: string = "./simple-project") {
  if (!process.env.DAYTONA_API_KEY) {
    ...
    console.error("Please create a .env file in the yeevu-ui directory with:");
    console.error("DAYTONA_API_KEY=your_daytona_api_key_here");
    console.error("\nYou can get your API key from your Daytona dashboard.");
    process.exit(1);
  }
