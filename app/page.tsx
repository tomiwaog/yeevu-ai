...
export default function Home() {
  ...
  const handleGenerate = () => {
    ...
    // Navigate to generate page with prompt (model defaults to claude-sonnet-4, but can be overridden via URL param)
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="relative flex items-center bg-black rounded-2xl border border-gray-800 shadow-2xl px-2">
              {/* Textarea */}
              <textarea
                placeholder="Ask Yeevu AI to create a prototype..."
                value={prompt}
